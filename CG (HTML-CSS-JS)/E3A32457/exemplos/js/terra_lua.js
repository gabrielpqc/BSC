...
//
Earth.ROTATION_Y = 0.001;   // velocidade de rotação da terra
...
Moon.PERIOD = 28;                       // período de rotação da lua em torno da terra
Moon.EXAGGERATE_FACTOR = 1.2;           // aumento para efeito de visualização
